...
const createBulkLicense = async (params: CreateLicenseParams) => {
  const url = `/license/bulk`;
...
const useCreateBulkLicense = () => {
  const queryClient = useQueryClient();
  return useMutation((params: CreateLicenseParams) => createBulkLicense(params), {
    onMutate: (variables) => {},
...
export default useCreateBulkLicense;
